...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.variable} font-sans bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#0A0F1A] to-black text-slate-100 min-h-screen antialiased overflow-x-hidden selection:bg-[#0066FF]/30 selection:text-[#0066FF]`}
      >
        <LiquidNavigation />
