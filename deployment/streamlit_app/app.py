...
st.markdown("End-to-end Air Quality Index forecast, Causal AI policy simulator, and satellite telemetry for Sargodha, Pakistan.")
            ...
            try:
                ...
                if pred_resp.status_code == 200:
                    ...
                    if hourly:
                        ...
                        fig.update_layout(xaxis_title="Time", yaxis_title="AQI", hovermode="x unified")
...
with tab_causal:
    ...
    st.markdown("Simulate Do-Calculus interventions on municipal traffic, biomass burning, and wind dispersion.")
...
with tab_satellite:
    ...
    st.markdown("Real-time tropospheric NO2 and Aerosol Optical Depth (AOD) column density mesh across Sargodha basin.")
...
with tab_canary:
    ...
    st.markdown("Real-time production shadow execution metrics evaluating 7 candidate models concurrently.")
